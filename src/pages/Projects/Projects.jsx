...
const projects = [
  {
    title: " Docs-lite! A robust and feature-rich collaborative text editor",
    description:
      "A MERN stack collaborative text editor with real-time updates via Socket.IO, image uploads, and persistent storage with MongoDB.",
    src: docImg,
    // link: "#",
    color: "#5196fd",
    githubLink: "https://github.com/Pankaj-Mahto/Docs-lite",
    liveLink: "https://docs-lite.onrender.com/",
  },
  {
        ...
        <div className="w-full flex flex-col md:flex-row bg-zinc-900 rounded-2xl overflow-hidden shadow-xl">
          ...
          <div className="w-full md:w-[55%] h-[250px] md:h-[400px] lg:h-[450px] relative overflow-hidden">
            <motion.img
              src={url}
              alt={title}
              className="w-full h-full object-coniner"
              initial={{ scale: 1 }}
