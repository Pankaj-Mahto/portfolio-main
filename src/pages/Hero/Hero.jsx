...
const profile = {
 name: 'Pankaj Kumar Mahto',
   ...
   skills: [
    'React', 'Redux', 'React Router', 'TypeScript', 'JavaScript',
  ...
  return (
    <>
      <main className="bg-[#020617] text-white min-h-screen">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Full-Stack Developer ✨ | MERN & React ⚡ | Problem Solver &
        ...
        {/* Scroll indicator */}
        <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 animate-bounce flex flex-col items-center gap-2 z-20">
          <span className="text-gray-400 text-sm flex items-center gap-2 bg-black/50 px-2 py-1 rounded">
